...
# preview details
title: "T5WikiX: T5 Fine-Tuning on Wikihow and XSum"
category: Music
category_slug: music
image: assets/img/projects/t5_cover.png
short: T5WikiX 

# full details
full_image: assets/img/projects/t5_cover.png
preview_link: https://github.com/Khamies/T5-Fine-tune-Wikihow-XSum
info:
  - label: Project Description
    value: This is a Pytorch implementation of a summarization model that is fine-tuned on the top of Google-T5 pre-trained model.

  - label: Tags
    value: nlp, pytorch, transformer summarization rouge-l abstractive-summarization wikihow xsum hugging-face t5-model
...
This is a `For-Learning` :green_book: project, where Google-Colab has been used as a running environment, and due to the limited budget :moneybag:  ( at this time :grin:) I could not be able to fully tune the model.

<img src="/assets/img/projects/t5.png" align="center" height="300" width="800" >
...
- **Cross Entropy Loss** 
  ...
  <img src="/assets/img/projects/t5_wiki_tr_loss.png" align="center" height="300" width="500" >
  
  - **Xsum**
  
    <img src="/assets/img/projects/t5_tr_loss.png" align="center" height="300" width="500" >
